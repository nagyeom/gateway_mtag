...
logging.basicConfig(filename='/var/www/inspection2018/gps_log.log', level=logging.DEBUG, format='%(asctime)s %(message)s')
    ...
    if request.headers['Content-Type']== 'application/json':
        ...
        if log is not None:
            ...
            for item in cpn_dict['items'] :
                if item['lat'] is not None or item['lon'] is not None:
